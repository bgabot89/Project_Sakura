    ...
    markers: [
      {
        ...
        showInfo: false,
        content: '<img class="event-icon" src="../../images/aod_2017.png"</img>' + '<p><b>AOD 2017</b></p>' + '<p><b>Rating:</b></p>' + '<p><b>Date: 03/18/17-03/19/17</b></p>' + '<p><b>Genre: <a href="/anime">Anime</a></p></b>' + '<p>AOD is a convention devoted to japanese anime and video games. Come and listen to the various musicians play music from your favorite japanese anime and video games. </p>' + '<a href="/comments">Post a comment</a>'
      },
      {
      ...
      },
      {
        ...
        showInfo: false,
        content: '<img class="event-icon" src="../../images/jpop-summit.png"</img>' + '<p><b>J-Pop Summit 2017</b></p>'+ '<p><b>Date: 09/09/17 - 09/10/17</b></p>' + '<p><b>Genre: <a href="/jrock">J-Rock</a></b></p>' + '<p>Listen to various j-pop artists in this special event in SF</p>' + '<a href="/comments">Post a comment</a>'
      }
    ]
  }
